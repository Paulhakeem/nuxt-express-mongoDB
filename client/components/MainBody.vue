<template>
  <div>
    <div
      class="rounded-r bg-gray-200 xl:hidden flex justify-between w-full p-6 items-center"
    >
      <div class="flex justify-between items-center space-x-3">
        ...
        <p class="text-2xl leading-6 text-white">LetsChat</p>
      </div>
    ...
    <div
      id="Main"
      class="xl:rounded-r transform xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start h-full w-full sm:w-64 bg-gray-900 flex-col h-screen"
    >
