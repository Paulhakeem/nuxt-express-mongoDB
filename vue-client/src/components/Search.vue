      ...
      >
        ...
        <div class="py-4 pl-4 text-sm cursor-pointer">
          <div class="flex gap-4 items-center">
            <img alt="profile-image" class="size-10 rounded-full object-cover" />
            <div>
              <h4 class="text-gray-200 font-medium capitalize">hakeem</h4>
              <p class="text-xs text-gray-400">paul@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
